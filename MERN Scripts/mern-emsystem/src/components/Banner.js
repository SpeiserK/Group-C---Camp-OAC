    ...
    render(){
        return(
            <Container fluid style={{paddingRight: 0}}>
                    ...
                    <Col xl={{span: 5, offset:0}} lg={{span: 7, offset:1}} md={{span: 7, offset:1}} ><Link to="/" className="Link" style={{textDecoration: 'none', padding: 20 }}><h1 className="bearHug">ogopogo rotary & camp oac</h1></Link> </Col>
